...
bool PipeTrackNode::rectanglesAreIntersected(const Point & startPoint1, const Point & endPoint1, CalcNumber width1, CalcNumber left2, CalcNumber right2, CalcNumber bottom2, CalcNumber top2) const {
    ...
    if (direction.x == 0 || direction.y == 0) {
        ...
        std::vector<std::pair<Point, Point>> edges1 = {
            std::pair<Point, Point>(startPoint1 + normal1, startPoint1 - normal1),
            std::pair<Point, Point>(endPoint1 + normal1, endPoint1 - normal1),
            std::pair<Point, Point>(startPoint1 + normal1, endPoint1 + normal1),
            std::pair<Point, Point>(startPoint1 - normal1, endPoint1 - normal1)
        };
        std::vector<std::pair<Point, Point>> edges2 = {
            std::pair<Point, Point>(Point(left2, bottom2, 0), Point(left2, top2, 0)),
            std::pair<Point, Point>(Point(right2, bottom2, 0), Point(right2, top2, 0)),
            std::pair<Point, Point>(Point(left2, bottom2, 0), Point(right2, bottom2, 0)),
            std::pair<Point, Point>(Point(left2, top2, 0), Point(right2, top2, 0))
        };
